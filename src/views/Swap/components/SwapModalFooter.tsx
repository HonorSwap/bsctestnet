...
import { Trade, TradeType } from '@honorswap/testnetsdk'
import { Button, Text, AutoRenewIcon } from '@honorswap/uiex'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards HNR buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />
